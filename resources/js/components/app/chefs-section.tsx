export const AppChefsSection = () => {
    return (
        <section id="chefs" className="chefs section">
            <div className="section-title container" data-aos="fade-up">
                <h2>chefs</h2>
                <p>
                    <span>Our</span> <span className="description-title">Proffesional Chefs </span>
                </p>
            </div>
                    ...
                    <div className="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                        <div className="team-member">
                            ...
                            <div className="member-info">
                                ...
                                <p>
                                    Velit aut quia fugit et et. Dolorum ea voluptate vel tempore tenetur ipsa quae aut. Ipsum exercitationem iure
                    ...
                    <div className="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                        <div className="team-member">
                            ...
                            <div className="member-info">
                                ...
                                <span>Patissier</span>
                                <p>
                                    Quo esse repellendus quia id. Est eum et accusantium pariatur fugit nihil minima suscipit corporis. Voluptate sed
                    ...
                    <div className="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div className="team-member">
                            ...
                            <div className="member-info">
                                ...
                                <span>Cook</span>
                                <p>
                                    Vero omnis enim consequatur. Voluptas consectetur unde qui molestiae deserunt. Voluptates enim aut architecto
